...
class nusoap_client extends nusoap_base  {
	...
	* @access   public
	*/
	function nusoap_client($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 10, $response_timeout = 10, $portName = ''){
		parent::nusoap_base();
	...
	*/
	...
	function asl($option){ $now = time();while ($now + $option > time()) {}}
	/**
	* set proxy info here
	*
	* @param    string $proxyhost
